...
import { User, Mail, Lock, Phone, ArrowRight, Eye, EyeOff, CheckCircle, Shield, Heart } from 'lucide-react';
...
const UserRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Call user registration API (you'll need to create this endpoint)
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join our physiotherapy community</p>
        </div>
