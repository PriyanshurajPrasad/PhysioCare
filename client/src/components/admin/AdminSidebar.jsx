      ...
      `}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          {!isCollapsed && (
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">PhysioCare</h1>
        ...
        {!isCollapsed && (
          <div className="p-4 border-t border-gray-200">
            <button
              ...
              className="w-full flex items-center px-3 py-2.5 text-sm font-medium text-red-600 rounded-xl hover:bg-red-50 transition-all duration-200"
              aria-label="Logout"
            >
        ...
        {isCollapsed && (
          <div className="p-4 border-t border-gray-200">
            <button
              onClick={handleLogout}
              className="w-full flex items-center justify-center p-2.5 text-red-600 rounded-xl hover:bg-red-50 transition-all duration-200"
              title="Logout"
              aria-label="Logout"
            >
